...
def main():
    ...
    if training_args.do_train:
        ...
        # =====================================================================================
        # Forzamos a la columna de audio a ser decodificada y remuestreada automáticamente
        # a la frecuencia de muestreo que el modelo espera (32000 Hz)
        raw_datasets = raw_datasets.cast_column(
            data_args.target_audio_column_name,
            datasets.Audio(sampling_rate=32000, decode=True),
        )
        # =====================================================================================
